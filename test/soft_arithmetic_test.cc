...
TEST_F(MulUnsignedHiTest, MulUnsignedHi_uint16_t) {
    ...
    const T a = 0x1234;
    const T b = 0x5678;
    ASSERT_EQ(rv64_emulator::libs::MulUnsignedHi(a, b), 0x626);
}
...
TEST_F(MulUnsignedHiTest, MulUnsignedHi_uint32_t) {
    ...
    ASSERT_EQ(rv64_emulator::libs::MulUnsignedHi(a, b), 0xb00ea4e);
}
...
TEST_F(MulUnsignedHiTest, MulUnsignedHi_uint64_t) {
    ...
    ASSERT_EQ(rv64_emulator::libs::MulUnsignedHi(a, b), 0x14b66dc33f6acdc);
}
