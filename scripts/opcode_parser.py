...
def ArgsBuild():
    parser = argparse.ArgumentParser(description="mask and data of instructions generator")
    parser.add_argument('--filename', type=str, required=True, help='offical opcode desc in github.com/riscv/riscv-opcodes')
    return parser.parse_args()


fmt_pattern = "{0:^10}\t{1:^10}\t{2:^10}"
