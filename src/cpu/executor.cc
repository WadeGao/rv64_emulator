...
#define MAKE_TRAP(etype, addr) \
  { .type = (etype), .val = (addr), }

#define ILL_TRAP(addr) MAKE_TRAP(trap::TrapType::kIllegalInstruction, (addr))
